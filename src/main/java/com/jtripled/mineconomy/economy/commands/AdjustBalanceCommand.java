 ...
 * @author jtripled
 */
public class AdjustBalanceCommand implements CommandExecutor
{
    public static final CommandSpec SPEC = CommandSpec.builder()
        .description(Text.of("Adjust the balance of the specified account."))
        .permission("mineconomy.admin")
        .executor(new AdjustBalanceCommand())
